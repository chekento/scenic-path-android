...
## ⬇️ [DOWNLOAD SCENIC PATH v0.7.3-rc4 APK](https://github.com/chekento/scenic-path-android/releases/download/v0.7.3-rc4/Scenic-Path-v0.7.3-rc4-debug.apk)

**Tap the large hero image above or the download text here — both point directly to the current APK.**

[Release notes](https://github.com/chekento/scenic-path-android/releases/tag/v0.7.3-rc4) ·
[SHA-256](https://github.com/chekento/scenic-path-android/releases/download/v0.7.3-rc4/Scenic-Path-v0.7.3-rc4-debug.apk.sha256)

`cloud.kosch.scenicpath` · Android 16 / API 36 · `versionCode 49` · stability RC
...
## Current Android build — v0.7.3-rc4

Build 49 repairs POI waypoint recalculation. When Valhalla snaps the incoming and outgoing leg of a selected POI to nearby different access roads, Scenic Path now requests a real vehicle-aware connector and includes it in the route metrics. Truly disconnected sections still fail safely; no straight-line route geometry is inserted.
...
**Direct download:**  
[Scenic-Path-v0.7.3-rc4-debug.apk](https://github.com/chekento/scenic-path-android/releases/download/v0.7.3-rc4/Scenic-Path-v0.7.3-rc4-debug.apk)

**Integrity:**  
[Scenic-Path-v0.7.3-rc4-debug.apk.sha256](https://github.com/chekento/scenic-path-android/releases/download/v0.7.3-rc4/Scenic-Path-v0.7.3-rc4-debug.apk.sha256)
...
- Target SDK: `36`
- Current version: `0.7.3-rc4`
- GitHub APK release: [`v0.7.3-rc4`](https://github.com/chekento/scenic-path-android/releases/tag/v0.7.3-rc4)
